...
impl<'db> Formatter<'db> {
    ...
    fn format_instr(&mut self, func_data: &FuncData, instr: &InstrData) -> SExpr {
        match instr {
            ...
            InstrData::FloatAdd(ins) => self.format_instr_binary("real.add", ins),
            InstrData::FloatSub(ins) => self.format_instr_binary("real.sub", ins),
            InstrData::FloatMul(ins) => self.format_instr_binary("real.mul", ins),
            InstrData::FloatDiv(ins) => self.format_instr_binary("real.div", ins),
            InstrData::FloatCmp(ins) => self.format_instr_cmp("real.cmp", ins),
            InstrData::FloatToInt(ins) => self.format_instr_unary("real.to_int", ins),
